        ...
        <Row className="container">
          ...
          <Col span={22}>
            <div className="leftContainer" style={{width: '35%'}} >
              ...
              <NewsImageBlock type="guoji" count={6} cardTitle="国际新闻" cardWidth="100%" imageWidth="123px"></NewsImageBlock>
            </div>
            ...
            <div>
              <NewsImageBlock type="guonei" count={8} cardTitle="国内新闻" cardWidth="100%" imageWidth="140px"></NewsImageBlock>
              <NewsImageBlock type="yule" count={16} cardTitle="娱乐新闻" cardWidth="100%" imageWidth="140px"></NewsImageBlock>
            </div>
          </Col>
          <Col span={1}></Col>
        </Row>
